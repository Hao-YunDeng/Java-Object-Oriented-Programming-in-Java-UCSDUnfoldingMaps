...
//			map = new UnfoldingMap(this, 200, 50, 650, 600, new Google.GoogleMapProvider());
	...
	private void addKey() {	
		...
		fill(color(139, 0, 0));
		triangle(50, 125-8, 50-6, 125+5, 50+6, 125+5);

		fill(0, 0, 0);
		text("City Marker", 75, 125);
		
		noFill();
		ellipse(50, 125+30, 10, 10);
		text("Land Quake", 75, 125+30);
		
		rect(50-5, 125+60-5, 10, 10);
		text("Ocean Quake", 75, 125+60);
		
		text("Size ~ Magnitude", 45, 125+90);
		
		fill(255, 255, 0);
		ellipse(50, 125+120, 10, 10);
		fill(0);
		text("Shallow", 75, 125+120);

		fill(0, 0, 255);
		ellipse(50, 125+140, 10, 10);
		fill(0);
		text("Intermediate", 75, 125+140);

		fill(255, 0, 0);
		ellipse(50, 125+160, 10, 10);
		fill(0);
		text("Deep", 75, 125+160);		
	}
